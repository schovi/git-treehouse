...
- **Status bar:** context-sensitive key hints, e.g. `↵ go · n new · d delete · o editor · p PR · y path · r refresh · s search · q quit`. During async loading it appends a small progress note (`fetching PRs…`).
